...
> `tasks`), continuação direta do ciclo `docs/sdd/specs/read-side/` (REQ-33..40,
> NFR-18..20, Marco I, completo). Nasce do gap **G-4** de
> `docs/sdd/specs/codegen/gaps.md` (registrado como **ISSUE-3** em
> `docs/sdd/issues/open-issues.md`): o sistema gerado hoje **não é implantável contra
...
6. `docs/sdd/specs/codegen/gaps.md` e `docs/sdd/issues/open-issues.md` atualizados: G-4/
