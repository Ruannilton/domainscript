...
- DESCRIPTION: [`tasks/M4.1.md`](../specs/correcoes-issues-6-8-12/tasks/M4.1.md)
  restringe `target_files` a [`codegen/gentest_property.go`](../../codegen/gentest_property.go)
  e `codegen/gentest_property_test.go` (ainda não existe — arquivo a criar
  por esta task).
  ...
  contra esse arquivo. Nem `codegen/gentest_test.go` nem
