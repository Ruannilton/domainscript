...
- DESCRIPTION: A [§13](../steerings/domainscript-spec-v7/13-module-infra.md)
  ...
  Onde mora: os leitores de config de
  [`codegen/decl_query_cache.go`](../../codegen/decl_query_cache.go#L295-L352)
  (`cacheBackendKind` e vizinhança, ~l.295-352) e
  [`codegen/ratelimit.go`](../../codegen/ratelimit.go) (`rateLimitBackendKind`,
  ~l.264 à época do registro), que exigem `*ast.Literal` de kind STRING.

  **Impacto nos exemplos.**
  [`testdata/projects/wallet/mod.ds`](../../testdata/projects/wallet/mod.ds)
  usa a forma com aspas (`backend: "redis"`) — gera, mas diverge do spec.
  [`testdata/projects/pizzeria/sales/mod.ds`](../../testdata/projects/pizzeria/sales/mod.ds)
  usa a forma do spec (`backend: memory`) — está correto e é **latentemente
  quebrado**: hoje o
